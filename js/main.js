...
(function () {
    ...
    gameArea = [
        ...
        11, 10, 11, 10, 10, 10, 10, 10, 10, 11,
        11, 10, 11, 11, 11, 10, 12, 10, 10, 11,
        11, 12, 10, 10, 11, 10, 10, 10, 10, 11,
        11, 10, 14, 10, 11, 11, 11, 10, 10, 11,
        11, 10, 14, 10, 10, 10, 10, 10, 10, 11,
        11, 10, 14, 14, 14, 14, 14, 14, 10, 11,
        11, 11, 11, 11, 10, 10, 10, 14, 10, 11,
        11, 10, 10, 12, 10, 10, 14, 14, 14, 11,
    ...
    var jump = function() {
        if (isBaddieMovable(0, -1)) {
            ...
            window.setTimeout(moveBaddie, 350, 0, 1);
            console.log("coming back down");
        }
    };
